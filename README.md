...
We organize this repository based on the data type and assumtions that migh not met. We'll try to update the list of resources as . Also, if there are sources that you find usefuel and you consider that should be included. 
